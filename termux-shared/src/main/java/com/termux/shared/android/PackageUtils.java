package com.termux.hg.shared.android;
...
public class PackageUtils {
    ...
    public static String getSigningCertificateSHA256DigestForPackage(@NonNull final Context context, @NonNull final String packageName) {
        try {
             ...
             * W/PackageManager: Failed to parse /path/to/com.termux.hg.tasker.apk: Signature mismatch for shared user: SharedUserSetting{xxxxxxx com.termux.hg/10xxx}
             */
