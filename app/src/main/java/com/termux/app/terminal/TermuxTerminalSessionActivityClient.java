...
import com.termux.hg.shared.termux.terminal.io.BellHandler;
import com.termux.hg.shared.logger.Logger;
import com.termux.hg.terminal.TerminalColors;
import com.termux.hg.terminal.TerminalSession;
import com.termux.hg.terminal.TerminalSessionClient;
import com.termux.hg.terminal.TextStyle;
    ...
    private synchronized void loadBellSoundPool() {
        if (mBellSoundPool == null) {
            ...
            try {
                ...
                // Catch java.lang.RuntimeException: Unable to resume activity {com.termux.hg/com.termux.hg.app.TermuxActivity}: android.content.res.Resources$NotFoundException: File res/raw/bell.ogg from drawable resource ID
