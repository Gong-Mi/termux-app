 ...
 * </ul>
 */
public final class JavaJavaTerminalEmulator {
    ...
    /**
     * @see JavaTerminalEmulator#mapDecSetBitToInternalBit(int)
     */
    ...
    private static final String LOG_TAG = "JavaTerminalEmulator";
    ...
    public String toString() {
        return "JavaTerminalEmulator[size=" + mScreen.mColumns + "x" + mScreen.mScreenRows + ", margins={" + mTopMargin + "," + mRightMargin + "," + mBottomMargin
            + "," + mLeftMargin + "}]";
    }
