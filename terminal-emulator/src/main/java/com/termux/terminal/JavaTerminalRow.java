 ...
 */
public final class JavaJavaTerminalRow {
    ...
    public JavaJavaTerminalRow(int columns, long style) {
        mColumns = columns;
    ...
    public void copyInterval(JavaTerminalRow line, int sourceX1, int sourceX2, int destinationX) {
    ...
    public void setChar(int columnToSet, int codePoint, long style) {
        if (columnToSet  < 0 || columnToSet >= mStyle.length)
            throw new IllegalArgumentException("JavaTerminalRow.setChar(): columnToSet=" + columnToSet + ", codePoint=" + codePoint + ", style=" + style);
