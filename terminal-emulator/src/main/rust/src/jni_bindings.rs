...
pub extern "system" fn Java_com_termux_terminal_RustTerminal_destroyEngine(
    ...
    if ptr != 0 {
        ...
        if pty_fd >= 0 {
            ...
            android_log(LogPriority::DEBUG, &format!("destroyEngine: Closed PTY fd {} to unblock IO thread", pty_fd));
        }
...
pub extern "system" fn Java_com_termux_terminal_RustTerminal_startIoThread(
    ...
    context.pty_fd.store(pty_fd, std::sync::atomic::Ordering::SeqCst);
