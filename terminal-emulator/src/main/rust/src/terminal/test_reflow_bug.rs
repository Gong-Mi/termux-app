...
mod tests {
    ...
    fn prove_reflow_stacking_bug() {
        ...
        assert!(!has_bug, "BUG PROVEN: The screen incorrectly wrapped the cursor row because it processed invisible trailing spaces. This pushes content down, causing the 'stacking' effect.");
    }
}
