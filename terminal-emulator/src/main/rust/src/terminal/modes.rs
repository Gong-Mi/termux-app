...
pub const DECSET_BIT_RECTANGULAR_CHANGEATTRIBUTE: i32 = 1 << 12;

// Standard Modes (Non-DECSET) - Use higher bits to avoid collision
pub const MODE_INSERT: i32 = 1 << 16;
pub const MODE_LNM: i32 = 1 << 17;
