...
static ZERO_WIDTH: &[(u32, u32)] = &[
    ...
    (0x00f39, 0x00f39), (0x00f71, 0x00f7e), (0x00f7f, 0x00f7f), (0x00f80, 0x00f84),
    ...
    (0x017dd, 0x017dd), (0x0180b, 0x0180d), (0x0180e, 0x0180e), (0x01885, 0x01886),
    ...
    (0x01cf8, 0x01cf9), (0x01dc0, 0x01dff), (0x020d0, 0x020f0), (0x02cef, 0x02cf1),
    ...
    (0x0a9bc, 0x0a9bc), (0x0a9bd, 0x0a9bd), (0x0a9e5, 0x0a9e5), (0x0aa29, 0x0aa2e),
...
pub fn get_char_width(ucs: u32) -> usize {
    if ucs == 0 || ucs == 0x034F || (ucs >= 0x200B && ucs <= 0x200F) || 
       ucs == 0x2028 || ucs == 0x2029 || (ucs >= 0x202A && ucs <= 0x202E) || 
